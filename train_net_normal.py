...
register_coco_instances("lis_train", {},
                        "/media/ubuntu/DATA4T/dataset/LIS_paixu/RGB-normal/annotations/lis_coco_png_train.json",
                        "/media/ubuntu/DATA4T/dataset/LIS_paixu/RGB-normal/images/")
...
class Trainer(DefaultTrainer): #1111111111
    ...
    def __init__(self, cfg):
        ...
        self.checkpointer = DetectionCheckpointer(
            ...
            model,
            "/media/ubuntu/DATA2T/DiffusionInst/model/normal",
            **kwargs,
            # trainer=weakref.proxy(self),
        )
        self.start_iter = 0
